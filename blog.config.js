...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.icmod.tech/', // 网站地址
  ...
  WIDGET_PET_LINK:
      ...
      'https://live2d-d3a.pages.dev/model/xiaomai/xiaomai.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
