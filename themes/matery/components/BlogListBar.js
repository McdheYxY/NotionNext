...
export default function BlogListBar(props) {
  ...
  if (category) {
    return (
            <div className="w-full drop-shadow-xl mt-14 lg:mt-6 rounded-md px-5 lg:border lg:rounded-xl lg:px-2 lg:py-4 bg-white dark:bg-hexo-black-gray  dark:border-black">
    ...
    return <div className="w-full drop-shadow-xl mt-14 lg:mt-6 rounded-md px-5 lg:border lg:rounded-xl lg:px-2 lg:py-4 bg-white dark:bg-hexo-black-gray  dark:border-black">
